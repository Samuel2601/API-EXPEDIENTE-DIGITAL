  ...
  getRsyncQueueStatus = [
    ...
    async (req, res) => {
      try {
        ...
        console.log(
          `📊 Usuario ${user.userId} consultando estado de cola rsync`
        );
  ...
  getDocumentTypes = [
    ...
    async (req, res) => {
      try {
        ...
        console.log(
          `📋 Usuario ${user.userId} consultando tipos de documentos`
        );
  ...
  searchFiles = [
    ...
    async (req, res) => {
      try {
        ...
        console.log(
          `🔍 Usuario ${user.userId} realizando búsqueda de archivos`
        );
        ...
        console.log(
          `✅ Búsqueda completada: ${result.files.length} resultados`
        );
